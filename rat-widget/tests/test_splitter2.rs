use rat_widget::splitter::{SplitResize, SplitState};

#[test]
fn test_0() {
  let mut sp = SplitState::new();
  sp.resize = SplitResize::Neighbours;
...
fn test_3() {
  ...
  sp.set_split_pos(0, 255);
  assert_eq!(sp.area_lengths(), &[29, 1, 10]);
  sp.set_split_pos(0, 32768);
  assert_eq!(sp.area_lengths(), &[29, 1, 10]);
  sp.set_split_pos(0, 1);
  assert_eq!(sp.area_lengths(), &[1, 29, 10]);
  ...
  assert_eq!(sp.area_lengths(), &[20, 19, 1]);
...
fn test_4() {
  ...
  sp.set_split_pos(0, 255);
  assert_eq!(sp.area_lengths(), &[19, 1, 10, 10]);
  sp.set_split_pos(0, 32768);
  assert_eq!(sp.area_lengths(), &[19, 1, 10, 10]);
  sp.set_split_pos(0, 1);
  assert_eq!(sp.area_lengths(), &[1, 19, 10, 10]);
  ...
  assert_eq!(sp.area_lengths(), &[10, 1, 19, 10]);
  sp.set_split_pos(1, 25);
  assert_eq!(sp.area_lengths(), &[10, 15, 5, 10]);
  sp.set_split_pos(1, 39);
  assert_eq!(sp.area_lengths(), &[10, 19, 1, 10]);
  sp.set_split_pos(1, 40);
  assert_eq!(sp.area_lengths(), &[10, 19, 1, 10]);
  sp.set_split_pos(1, 41);
  assert_eq!(sp.area_lengths(), &[10, 19, 1, 10]);
  ...
  assert_eq!(sp.area_lengths(), &[10, 10, 5, 15]);
  sp.set_split_pos(2, 39);
  assert_eq!(sp.area_lengths(), &[10, 10, 19, 1]);
