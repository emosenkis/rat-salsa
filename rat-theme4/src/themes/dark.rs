...
pub fn create_dark(p: Palette) -> SalsaTheme {
  ...
  th.define_style(
    ...
    th.p
      .fg_bg_style_alias(Color::CONTAINER_BORDER_FG, Color::CONTAINER_BASE_BG),
  );
  th.define_style(
    Style::CONTAINER_ARROW_FG,
    th.p
      .fg_bg_style_alias(Color::CONTAINER_ARROW_FG, Color::CONTAINER_BASE_BG),
  );
  ...
  th.define_style(
    ...
    th.p
      .fg_bg_style_alias(Color::DOCUMENT_BORDER_FG, Color::DOCUMENT_BASE_BG),
  );
  th.define_style(
    Style::DOCUMENT_ARROW_FG,
    th.p
      .fg_bg_style_alias(Color::DOCUMENT_ARROW_FG, Color::DOCUMENT_BASE_BG),
  );
  ...
  th.define_style(
    ...
    th.p
      .fg_bg_style_alias(Color::POPUP_BORDER_FG, Color::POPUP_BASE_BG),
  );
  th.define_style(
    Style::POPUP_ARROW_FG,
    th.p
      .fg_bg_style_alias(Color::POPUP_ARROW_FG, Color::POPUP_BASE_BG),
  );
  ...
  th.define_style(
    ...
    th.p
      .fg_bg_style_alias(Color::DIALOG_BORDER_FG, Color::DIALOG_BASE_BG),
  );
  th.define_style(
    Style::DIALOG_ARROW_FG,
    th.p
      .fg_bg_style_alias(Color::DIALOG_ARROW_FG, Color::DIALOG_BASE_BG),
  );
