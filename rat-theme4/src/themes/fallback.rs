...
pub fn create_fallback(p: Palette) -> SalsaTheme {
  ...
  th.p
    .add_aliased(Color::MONTH_HEADER_FG, ColorIdx::default());
  th.p.add_aliased(Color::INPUT_FOCUS_BG, ColorIdx::default());
  th.p
    .add_aliased(Color::INPUT_SELECT_BG, ColorIdx::default());
  ...
  th.p
    .add_aliased(Color::CONTAINER_BASE_BG, ColorIdx::default());
  th.p
    .add_aliased(Color::CONTAINER_BORDER_FG, ColorIdx::default());
  th.p
    .add_aliased(Color::CONTAINER_ARROW_FG, ColorIdx::default());
  th.p
    .add_aliased(Color::DOCUMENT_BASE_BG, ColorIdx::default());
  th.p
    .add_aliased(Color::DOCUMENT_BORDER_FG, ColorIdx::default());
  th.p
    .add_aliased(Color::DOCUMENT_ARROW_FG, ColorIdx::default());
  th.p.add_aliased(Color::POPUP_BASE_BG, ColorIdx::default());
  th.p
    .add_aliased(Color::POPUP_BORDER_FG, ColorIdx::default());
  th.p.add_aliased(Color::POPUP_ARROW_FG, ColorIdx::default());
  th.p.add_aliased(Color::DIALOG_BASE_BG, ColorIdx::default());
  th.p
    .add_aliased(Color::DIALOG_BORDER_FG, ColorIdx::default());
  th.p
    .add_aliased(Color::DIALOG_ARROW_FG, ColorIdx::default());
