...
Cobald-oxide and some Chromium-oxide too.",
  ...
  color: [
    ...
    Palette::interpolate2(0x070607, 0x0f0e0d, 0x0, 0x0),
  ...
  aliased: Cow::Borrowed(&[
    ...
    define_alias("footer.fg", Colors::TextLight, 1),
    define_alias("header.bg", Colors::Blue, 0),
    define_alias("header.fg", Colors::TextLight, 1),
    ...
    define_alias("title.bg", Colors::Blue, 1),
