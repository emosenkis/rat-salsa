...
pub const TAILWIND_SHELL: Palette = Palette {
  theme_name: Cow::Borrowed("Tailwind Shell"),
  ...
  aliased: Cow::Borrowed(&[
    ...
    define_alias("footer.fg", Colors::Primary, 1),
    define_alias("header.bg", Colors::None, 0),
    define_alias("header.fg", Colors::Primary, 1),
    ...
    define_alias("key-binding.bg", Colors::Primary, 2),
