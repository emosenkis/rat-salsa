...
/// Imperial
/// Purple and gold.
pub const IMPERIAL_SHELL: Palette = Palette {
  theme_name: Cow::Borrowed("Imperial Shell"),
  ...
  aliased: Cow::Borrowed(&[
    ...
    define_alias("footer.fg", Colors::Yellow, 2),
    define_alias("header.bg", Colors::None, 0),
    define_alias("header.fg", Colors::Yellow, 2),
    ...
    define_alias("key-binding.bg", Colors::Yellow, 0),
