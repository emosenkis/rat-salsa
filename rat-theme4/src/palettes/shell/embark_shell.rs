...
/// Embark
pub const EMBARK_SHELL: Palette = Palette {
  theme_name: Cow::Borrowed("Embark Shell"),
  ...
  color: [
    ...
    Palette::interpolate(0x413f70, 0x5f5ea5, DARKNESS),
  ...
  aliased: Cow::Borrowed(&[
    ...
    define_alias("footer.fg", Colors::BlueGreen, 0),
    define_alias("header.bg", Colors::None, 0),
    define_alias("header.fg", Colors::BlueGreen, 0),
