...
use crate::{
  HasScreenCursor, TextError, TextFocusGained, TextFocusLost, TextPosition,
...
impl Default for TextInputState {
  fn default() -> Self {
    let value =
      TextCore::new(Some(Box::new(UndoVec::new(99))), Some(global_clipboard()));
