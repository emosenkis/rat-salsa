  ...
  pub fn into_constraint(
    ...
    match self {
      ...
      Placement::AboveOrBelow => {
        PopupConstraint::AboveOrBelow(alignment, relative_to_area)
      }
      Placement::BelowOrAbove => {
        PopupConstraint::BelowOrAbove(alignment, relative_to_area)
      }
