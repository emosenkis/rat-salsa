...
pub fn motion_start_position(
  ...
  match motion {
    ...
    Motion::Bracket(_to) => todo!(),
    Motion::Parenthesis(_to) => todo!(),
    Motion::Angled(_to) => todo!(),
    Motion::Tagged(_to) => todo!(),
    Motion::Brace(_to) => todo!(),
    Motion::Quoted(_c, _to) => todo!(),
    _ => state.cursor(),
  }
}
