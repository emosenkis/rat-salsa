...
fn pskip_paragraph_whitespace<'a, C: Cursor<Item = Grapheme<'a>>>(
  it: &mut C,
) -> bool {
...
fn skip_paragraph_whitespace<'a, C: Cursor<Item = Grapheme<'a>>>(
  it: &mut C,
) -> bool {
  let mut skipped = false;
  loop {
