...
pub fn sample_rust() -> (Rope, Vec<(TextRange, usize)>) {
  (Rope::from_str(RUST_SAMPLE), Vec::new())
}
...
static RUST_SAMPLE: &str = r#"use crate::vi::{Direction, Finds, Mark, Matches, SyncRanges, TxtObj};
